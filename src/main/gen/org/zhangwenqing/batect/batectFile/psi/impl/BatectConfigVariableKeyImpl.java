...
public class BatectConfigVariableKeyImpl extends ASTWrapperPsiElement implements BatectConfigVariableKey {

  public BatectConfigVariableKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatectVisitor visitor) {
    visitor.visitConfigVariableKey(this);
  }
