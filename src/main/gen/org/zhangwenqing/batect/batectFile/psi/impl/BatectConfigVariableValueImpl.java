...
public class BatectConfigVariableValueImpl extends ASTWrapperPsiElement implements BatectConfigVariableValue {

  public BatectConfigVariableValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatectVisitor visitor) {
    visitor.visitConfigVariableValue(this);
  }
  ...
  public BatectPropertyList getPropertyList() {
    return findChildByClass(BatectPropertyList.class);
  }
