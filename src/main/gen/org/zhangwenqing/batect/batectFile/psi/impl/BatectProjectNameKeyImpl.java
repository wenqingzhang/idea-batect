...
public class BatectProjectNameKeyImpl extends ASTWrapperPsiElement implements BatectProjectNameKey {

  public BatectProjectNameKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatectVisitor visitor) {
    visitor.visitProjectNameKey(this);
  }
