...
public class BatectPropertyList2Impl extends ASTWrapperPsiElement implements BatectPropertyList2 {

  public BatectPropertyList2Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatectVisitor visitor) {
    visitor.visitPropertyList2(this);
  }
  ...
  public BatectPropertyList2 getPropertyList2() {
    return findNotNullChildByClass(BatectPropertyList2.class);
  }
