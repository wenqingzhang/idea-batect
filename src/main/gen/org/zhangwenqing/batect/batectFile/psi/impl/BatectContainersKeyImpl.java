...
public class BatectContainersKeyImpl extends ASTWrapperPsiElement implements BatectContainersKey {

  public BatectContainersKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatectVisitor visitor) {
    visitor.visitContainersKey(this);
  }
