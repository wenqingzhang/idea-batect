...
public class BatectIncludeKeyImpl extends ASTWrapperPsiElement implements BatectIncludeKey {

  public BatectIncludeKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatectVisitor visitor) {
    visitor.visitIncludeKey(this);
  }
