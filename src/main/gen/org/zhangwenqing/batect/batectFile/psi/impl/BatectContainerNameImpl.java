...
public class BatectContainerNameImpl extends ASTWrapperPsiElement implements BatectContainerName {

  public BatectContainerNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatectVisitor visitor) {
    visitor.visitContainerName(this);
  }
