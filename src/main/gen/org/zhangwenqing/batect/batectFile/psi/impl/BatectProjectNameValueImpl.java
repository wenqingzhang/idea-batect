...
public class BatectProjectNameValueImpl extends ASTWrapperPsiElement implements BatectProjectNameValue {

  public BatectProjectNameValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatectVisitor visitor) {
    visitor.visitProjectNameValue(this);
  }
